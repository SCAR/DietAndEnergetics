...
Detailed data information can be found in the [metadata record](https://data.aad.gov.au/metadata/records/SCAR_Diet_Energetics), and the data can be downloaded from the [GitHub repository](https://github.com/SCAR/sohungry/releases).
