...
current_doi <- so_doi()
doi_link_md <- paste0("[doi:", current_doi, "](https://doi.org/", current_doi, ")")
```
...
A download link can be found along with detailed data information in the [metadata record](https://data.aad.gov.au/metadata/records/SCAR_Diet_Energetics).

Access is also possible via the R packages [sohungry](https://github.com/SCAR/sohungry) (for data) and [solong](https://github.com/SCAR/solong) (for allometric equations).
...
<div style="padding-left: 2em;">
Scientific Committee on Antarctic Research (2018) Southern Ocean Diet and Energetics Database. `r doi_link_md`
</div>
...
- Chaolun Li and colleagues (zooplankton lipid and stable isotope data)
...
- Arnaud Tarroux, Kit Kovacs, and collaborators (seal and penguin stable isotope data)
