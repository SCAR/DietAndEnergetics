...
m %>% addMarkers(lng = tempd$lon, lat = tempd$lat, group = "diet", clusterOptions = cluster_options, popup = popup_d) %>% ##, label=tempd$place_name
...
<img style="float:right;" src="http://mirrors.creativecommons.org/presskit/buttons/88x31/svg/by.svg" />
