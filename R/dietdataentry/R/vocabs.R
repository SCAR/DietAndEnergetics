...
vocab <- function(thing) {
    switch(tolower(thing),
           ...
           identification_method = c("bolus content", "caecum content", "foregut DNA content (18S)", "gizzard content", "gastrovascular content", "gut content", "gut content?", "gut pigment", "inferred from predator morphology", "lipid", "nest detritus", "observed predation", "observed predation (experimental)", "regurgitate content", "regurgitate content?", "regurgitated cast content", "scat content", "stable isotope", "stomach content", "stomach DNA content (COI)", "stomach DNA content (18S)", "stomach flushing", "stomach flushing (multiple flushes)", "stomach flushing?", "unknown", "weighing"),
           ...
           breeding_stage = c("breeding", "brooding", "chick rearing", "creche", "developing", "early chick rearing", "fasting", "fledging", "gravid", "guard", "incubation", "lactating", "mature (small eggs; some cream)", "moulting", "non breeding", "post breeding", "posthatching", "pregnant", "prehatching", "re-developing (post spent)", "running ripe", "spent", "weaning"),
           size_units = c("mm", "cm", "m"),
           mass_units = c("mg", "g", "kg", "t"),
           qualitative_dietary_importance = c("almost exclusive", "exclusive", "incidental", "major", "minor", "none"),
           size_notes = c("body length", "carapace length", "disk diameter", "dorsal mantle length", "given as standard length, should be mantle length?", "hood length", "large", "lower hood length", "lower rostral length", "mantle length", "medium", "otolith diameter", "otolith length", "prosome length", "small", "standard length", "total length (standard 1 length)", "test diameter", "total body length", "total length", "uropod length"),
           ...
           body_part_used = c("anterior nectophores", "anterior region", "aristotle's lantern muscle", "arms", "beaks", "blades", "blood", "body fragments", "body tissue", "body wall", "bone collagen", "buccal mass", "cellular fraction of blood", "central disk test", "collar", "down", "ectoderm", "egg white", "eggshell", "epidermis", "excluding shell?", "exoskeleton", "faeces", "feather", "feathers", "food sample", "foot muscle", "gonads", "liver", "hair", "holdfasts", "hood", "intestine tissue", "large beaks", "lateral walls", "lower beak rostrums", "lower beaks", "lower body region", "mantle", "medium beaks", "muscle tissue", "muscle tissue or soft body parts", "muscle tissue or whole animal", "ovaries", "peristome", "placenta", "plasma", "podial vesicles", "pooled specimens", "red blood cells", "serum cholesterol", "shell adductor muscle", "siphon muscle", "skin", "small beaks", "spine muscle", "stipes", "stomach caecum", "stomach oil", "tentacles", "test", "tissue", "tube feet", "upper beaks", "white muscle", "whole organism without shell", "whole organism without gut", "whole blood", "whole food sample", "whole or gutted fish", "whole organism", "whole sample", "whole stomach content", "wings"),
